...
<body>
    ...
    <div class="footer-copyright">
        <div class="container">
            &copy; <?php echo date("Y") ?> Build With <i class="fa fa-heart" style="color:red"></i> - <a href="https://www.andridesmana.pw" target="_blank" style="text-decoration:none">Kelompok 6</a>
        </div>
    </div>
